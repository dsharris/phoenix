...
function getNamedAnchor ( name ) {
  ...
  switch ( name ) {
    ...
    case 'left-three-forths': return [false, false];
    case 'right-one-forth':   return [false, false];
    case 'left-two-thirds':   return [false, false];
    case 'right-one-third':   return [false, false];
    /* DEFAULT */
